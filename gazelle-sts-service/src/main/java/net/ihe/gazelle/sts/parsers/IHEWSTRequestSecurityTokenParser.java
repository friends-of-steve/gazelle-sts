 ...
 * @version $Id: $Id
 */
public class IHEWSTRequestSecurityTokenParser extends WSTRequestSecurityTokenParser {
        ...
        while (xmlEventReader.hasNext()) {
            ...
            try {
                ...
                if (tag.equals(WSTrustConstants.REQUEST_TYPE)) {
                    ...
                    subEvent = StaxParserUtil.getNextStartElement(xmlEventReader);
                    IHEWSTValidateTargetParser wstValidateTargetParser = new IHEWSTValidateTargetParser();
                    ValidateTargetType validateTarget = (ValidateTargetType) wstValidateTargetParser
                    ...
                    if (StaxParserUtil.matches(subEvent, X509CERTIFICATE)) {
                    ...
                    } else if (StaxParserUtil.matches(subEvent, WSTrustConstants.XMLDSig.KEYINFO)) {
                        ...
                        throw new RuntimeException(
                                ErrorCodes.UNSUPPORTED_TYPE + StaxParserUtil.getStartElementName(subEvent));
                    }
                    ...
                    if (!StaxParserUtil.hasTextAhead(xmlEventReader)) {
                        throw new ParsingException(
                                ErrorCodes.EXPECTED_TEXT_VALUE + WSTrustConstants.COMPUTED_KEY_ALGORITHM);
                    }
